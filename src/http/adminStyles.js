...
.lite-shell .admin-sidebar{border:none;border-right:1px solid var(--border);border-radius:0;background:transparent;position:sticky;top:0;display:flex;flex-direction:column;align-self:start;min-height:calc(100vh - 3rem);overflow:visible;z-index:20}
.sidebar-desktop{display:flex;flex-direction:column;flex:1 1 auto;min-height:100%}
.sidebar-mobile{display:none}
.sidebar-mobile::before{content:"";display:none}
...
.sidebar-mobile strong{display:block;font-family:'Cormorant Garamond',Georgia,serif;font-size:1.5rem;line-height:.95}
.sidebar-head span{display:block;color:var(--text-secondary);font-size:.85rem;margin-top:.2rem}
.sidebar-mobile-brand{display:flex;align-items:center;gap:.7rem;min-width:0;color:var(--text)}
...
.sidebar-postscript{display:grid;gap:.45rem;padding-bottom:.95rem;margin-bottom:.85rem;border-bottom:1px solid var(--border)}
.sidebar-postscript a{display:inline-flex;align-items:center;gap:.55rem;color:var(--text-secondary);text-decoration:none;font-size:.95rem}
.sidebar-postscript a:hover{text-decoration:underline;text-underline-offset:.12em;color:var(--text)}
.sidebar-postscript-mark{width:.92rem;height:.92rem;display:inline-flex;align-items:center;justify-content:center;flex:none}
.sidebar-postscript-mark img{display:block;width:100%;height:100%;object-fit:contain}
.sidebar-version{margin:0 0 .85rem;color:var(--text-secondary);font-size:.95rem}
...
.sidebar-mobile-toggle{display:flex;align-items:center;justify-content:space-between;gap:1rem;padding:.85rem 1rem;cursor:pointer;list-style:none;background:color-mix(in srgb,var(--bg) 82%, var(--surface));backdrop-filter:blur(14px)}
.sidebar-mobile-toggle::-webkit-details-marker{display:none}
.sidebar-mobile-trigger{display:inline-flex;align-items:center;justify-content:center;min-width:4.75rem;padding:.42rem .72rem;border:1px solid var(--border);border-radius:999px;background:color-mix(in srgb,var(--surface) 88%, transparent);color:var(--text-secondary);font-size:.88rem;font-weight:600}
.sidebar-mobile[open] .sidebar-mobile-trigger{background:color-mix(in srgb,var(--surface-2) 78%, transparent);color:var(--text)}
.sidebar-mobile-panel{display:grid;gap:.2rem}
...
@media (max-width: 1080px){.admin-shell{grid-template-columns:1fr}.admin-sidebar{position:static}.lite-shell .admin-sidebar{position:sticky;top:0;min-height:auto;border-right:none;border-bottom:1px solid var(--border);background:color-mix(in srgb,var(--bg) 84%, var(--surface));backdrop-filter:blur(14px)}.lite-shell .sidebar-desktop{display:none}.lite-shell .sidebar-mobile{display:block;position:relative}.lite-shell .sidebar-mobile[open]::before{display:block;position:fixed;inset:4.5rem 0 0;background:rgba(10,16,24,.18);backdrop-filter:blur(2px);z-index:0}.lite-shell .sidebar-mobile-toggle{position:relative;z-index:2}.lite-shell .sidebar-mobile-panel{position:absolute;top:100%;left:0;right:0;padding:.4rem 0 1rem;border-top:1px solid var(--border);border-bottom:1px solid var(--border);background:linear-gradient(180deg,color-mix(in srgb,var(--surface) 98%, transparent),color-mix(in srgb,var(--surface) 92%, var(--surface-2)));box-shadow:0 18px 34px rgba(0,0,0,.12);max-height:min(calc(100vh - 4.5rem),36rem);overflow:auto;z-index:1}.lite-shell .sidebar-mobile .sidebar-nav{padding:.65rem .75rem .4rem}.lite-shell .sidebar-mobile .sidebar-footer{padding:.55rem .75rem 1rem;border-top:none}.lite-shell .sidebar-mobile .sidebar-postscript{padding-bottom:.8rem;margin-bottom:.75rem}.lite-main{position:relative;z-index:1;max-height:none;overflow:visible;min-height:0}.lite-main > *,.lite-panel,.lite-toolbar,.toolbar-row,.toolbar-row form,.toolbar-group,.toolbar-field,.settings-form,.settings-form form,.copy-block{min-width:0;max-width:100%}.subgrid,.split-panel,.identity-grid{grid-template-columns:1fr}.memory-table,.model-table{min-width:100%;table-layout:fixed}.memory-content,.model-table .notes{max-width:none}.lite-shell{border-radius:14px}.lite-main .split-panel{padding:1rem}.lite-main .split-panel > .card:first-child{border-right:none;border-bottom:1px solid var(--border);padding-right:0;padding-bottom:1rem}.lite-main .split-panel > .card:last-child{padding-left:0;padding-top:1rem}}
...
@media (max-width: 860px){body{padding:1rem}.toolbar{align-items:stretch}.lite-panel,.lite-toolbar,.proactive-shell,.proactive-shell.flat{padding-left:1rem;padding-right:1rem}.memory-table-wrap,.model-table-wrap{overflow:visible}.memory-table,.model-table{min-width:100%}.memory-table thead,.model-table thead{display:none}.memory-table,.model-table,.memory-table tbody,.model-table tbody{display:block}.memory-table tbody,.model-table tbody{display:grid;gap:.9rem}.memory-table tbody tr,.model-table tbody tr{display:grid;gap:.7rem;padding:1rem;border:1px solid var(--border);border-radius:12px;background:color-mix(in srgb,var(--surface) 86%, transparent)}.memory-table tbody td,.model-table tbody td{display:grid;grid-template-columns:minmax(6.5rem,8rem) minmax(0,1fr);gap:.75rem;align-items:start;padding:0;border-top:none;min-width:0}.memory-table tbody td::before,.model-table tbody td::before{content:attr(data-label);font-size:.74rem;letter-spacing:.08em;text-transform:uppercase;color:var(--text-secondary);font-weight:600}.memory-table tbody td.empty-state,.model-table tbody td.empty-state{display:block;padding:1rem}.memory-table tbody td.empty-state::before,.model-table tbody td.empty-state::before{content:none}.memory-table th.updated-col,.memory-table td.updated-col,.memory-table th.actions-col,.memory-table td.actions-col{width:auto;white-space:normal}.memory-table tbody td.actions-col{grid-template-columns:1fr}.memory-table tbody td.actions-col::before{margin-bottom:.1rem}.memory-table tbody td.actions-col .row-actions{justify-content:flex-start;flex-wrap:wrap}.model-table .notes,.memory-content{max-width:none}.toolbar-field.search,.toolbar-field.select{width:100%;max-width:none;min-width:0}}
`;
